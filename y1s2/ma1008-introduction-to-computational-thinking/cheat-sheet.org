...
** Sorting algorithms
- Sorting algorithms are algorithms that puts elements in a list of a certain order.
...
- It is invented by Tim Peters in 2002 for use in the Python programming langugage.
...
- In a way, it's the worse version of the ~string.find~ method.
