...
\section{Definitions}
\label{sec:org247fdfe}

\subsection{Programming}
\label{sec:org7c09845}
...
\subsection{Datum}
\label{sec:org7565b0b}
A datum is a number.

\subsection{Byte}
\label{sec:orgfe911a2}
1 byte = 8 bits (2 hex digits)

\subsection{Nibble}
\label{sec:orgfe8e102}
1 nibble = 4 bits (1 hex digit)

\subsection{Word}
\label{sec:org2e88422}
1 word = 16 or 32 bits depending on CPU architecture (32 bits is used in this course)

\subsection{DWord}
\label{sec:orge6b7153}
1 DWord = 64 bits

\subsection{Algorithms}
\label{sec:orgd47c681}
\begin{itemize}
...
\label{sec:org463a4a8}

\subsection{Interpretation approach}
\label{sec:org706c763}
\begin{itemize}
...
\label{sec:org19fcc19}

\subsection{Central processing unit (CPU)}
\label{sec:org9eb9eec}
\begin{itemize}
...
\label{sec:orgd953d5a}

\subsection{Types of information}
\label{sec:orgee92a50}
\begin{itemize}
\item Instructions
\item Data
\end{itemize}
...
\label{sec:org310f885}

\subsubsection{Binary format (base-2)}
\label{sec:orgfe3ff55}
\begin{itemize}
...
\label{sec:orgdff6ab6}

\subsection{Instruction execution}
\label{sec:org9abc50f}
\begin{enumerate}
...
\label{sec:org3a9925d}

\subsection{Look before you leap (LBYL)}
\label{sec:orgb0fc951}
\begin{itemize}
...
\label{sec:org0b20c6d}

\subsection{Bubble sort}
\label{sec:org8c6890d}
...
\label{sec:org0fdbcfe}

\subsection{Iterative binary search}
\label{sec:org081d26f}
\begin{verbatim}
...
\label{sec:org6c8631e}

\subsection{Statements}
\label{sec:org17a575d}
...
\label{sec:orgf0a99e0}

\subsubsection{Defining a function}
\label{sec:org86063f6}
\begin{itemize}
\item Functions in Python are defined using the \texttt{def} keyword.
\item After the \texttt{def} keyword comes the name of the function, which has the same rules as Python identifiers. Refer to the \hyperref[org39026e6]{section on Python identifiers} for the rules.
...
\label{sec:org8b9bbde}

\subsubsection{\texttt{try} block}
\label{sec:org66ac8e5}
\begin{itemize}
...
\label{sec:org72126c8}

\subsection{Floor division operator (\texttt{//})}
\label{sec:org3961997}
\begin{itemize}
...
\label{sec:org2b7a684}
Return the first \textbf{"falsy"} value if there are any, else return the \textbf{last} value in the expression. Refer to the \hyperref[org885cbd7]{section on "truthy" and "falsy" values} for an explanation of "falsy".

\subsubsection{Syntax}
\label{sec:orgdda54e9}
\begin{verbatim}
a and b
\end{verbatim}

\subsubsection{Example}
\label{sec:orgdb0558d}
\begin{verbatim}
a = 1
b = 5
print(a > 1 and b < 10)
...
\label{sec:org23b82fe}
Return the first \textbf{"truthy"} value if there are any, else return the \textbf{last} value in the expression. Refer to the \hyperref[org885cbd7]{section on "truthy" and "falsy" values} for an explanation of "truthy".

\subsubsection{Syntax}
\label{sec:orga5361f3}
\begin{verbatim}
a or b
\end{verbatim}

\subsubsection{Example}
\label{sec:org7c026bf}
\begin{verbatim}
a = 1
b = 5
print(a > 1 or b < 10)
