...
@@latex: ~\\~ \noindent@@ *Minimum Python version: 3.11*
...
@@latex: ~\\~ \noindent@@ Otherwise, if you used Homebrew to install Python, then use the command below to install the ~tk~ library.
#+begin_src
...
* Licence
This program is licensed under the GNU GPL V3 licence. You can view the ~LICENSE.txt~ file that is distributed with the program for the licence text.
