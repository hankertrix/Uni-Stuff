...
\label{sec:org8801029}

\subsubsection{Manual installer}
\label{sec:org24dece9}
...
\label{sec:orga759555}

\subsubsection{Manual installer}
\label{sec:org6582262}
...
\subsubsection{Arch-based distributions (Arch, Manjaro, EndeavourOS, etc.)}
\label{sec:org7fca6d0}
\begin{verbatim}
sudo pacman -S tk
\end{verbatim}

\subsubsection{Debian-based distributions (Debian, Ubuntu, Linux Mint, etc.)}
\label{sec:org89f5c1e}
\begin{verbatim}
sudo apt install tk-dev
\end{verbatim}

\subsubsection{Fedora and Fedora derivatives (Nobara, Asahi Linux, etc.)}
\label{sec:org396c9d2}
\begin{verbatim}
sudo dnf install tk-devel
\end{verbatim}

\subsubsection{Gentoo}
\label{sec:org6e9786a}
...
\label{sec:org71d5144}

\subsubsection{Original}
\label{sec:orgcab7eeb}
\begin{center}
...
\label{sec:org1ab1002}

\subsection{Strengths}
\label{sec:orgd5cfedb}
\begin{itemize}
...
\section{Licence}
\label{sec:org67b4471}
This program is licensed under the GNU GPL V3 licence. You can view the \texttt{LICENCE.txt} file that is distributed with the program for the licence text.
\end{document}
