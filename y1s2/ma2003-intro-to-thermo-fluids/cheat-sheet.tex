...
\section{Definitions}
\label{sec:org2a0949e}

\subsection{System (sys)}
\label{sec:org92922c5}
\begin{itemize}
...
\label{sec:orgac34fc7}

\subsubsection{Boyle's law}
\label{sec:orga96039e}
...
\label{sec:orgb4eccf3}

\subsubsection{Total energy (\(E_{\text{system}}\))}
\label{sec:orgc3b4819}
...
\label{sec:orgb337178}

\subsection{Resultant force}
\label{sec:orgefc6b3a}
\[F_R = \rho g h_c A\]
...
\label{sec:org9f980f0}

\subsection{Horizontal force}
\label{sec:orgbc695c8}

\subsubsection{Magnitude}
\label{sec:org97e4a1e}
