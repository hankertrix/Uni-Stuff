...
def _(GREEN_COLOUR, html, html_heading, md):
    ...
    html(
        ...
        md("By: Member 1, Member 2, Member 3 and Member 4")
        .center()
        .style(padding="5em"),
    )
    return
...
def _(html, md, md_unnumbered_list):
    ...
    md(
        ...
        md_unnumbered_list(
            html(
                "Member 2 was in charge of the exploratory analysis section",
                "and looked up all the regressors in Scikit-Learn to train",
                "and evaluate the models' performance on the data set.",
            ),
            html(
                "Member 1 handled data cleaning and imputation,",
                "as well as data preparation for each of the problems,",
                "making use of Member 2's results to select an",
                "applicable imputer to be used to fill in missing values.",
            ),
            html(
                "Member 4 was responsible for solving problem 1,",
                "making use of the imputed data to draw regression lines",
                "to show the trend, and interpreting the resulting trends",
                "to draw our conclusions.",
            ),
            html(
                "Member 3 was in charge of problem 2,",
                "also making use of Member 2's results to determine",
