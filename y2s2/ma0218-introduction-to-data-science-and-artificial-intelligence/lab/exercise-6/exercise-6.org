...
for index, centre in enumerate(model.cluster_centers_):
    ...
    # Get the total and the speed of the centre
    total, speed = centre

    # Add the cluster number with the data to the list of strings
    centre_str_list.append(f"Cluster {index + 1}:\t{total:.2f}\t{speed:.2f}")
...
:
: Cluster 1:	1508.20	475.18
: Cluster 2:	1012.02	353.54
: Cluster 3:	2839.64	715.02
: Cluster 4:	1998.87	600.03
...
#+RESULTS:
[[file:./.ob-jupyter/99d87ff02dc105006f07f38b6a15423129480b46.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/8dc06803083315fc2eb2a0af5f197b845318c0dd.png]]
