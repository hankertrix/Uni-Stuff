...
\label{sec:org638167e}

\subsection{Reasoning}
\label{sec:org1fa3016}
...
\label{sec:org68c6ccd}

\subsubsection{Analogy 1}
\label{sec:org4552079}
...
\label{sec:org902eaa4}
\[(T1) \vdash O(p \wedge q) \rightarrow Oq\]
\subsubsection{Proof}
\label{sec:org162065b}
\begin{enumerate}
...
\label{sec:org0c0fcbd}

\subsubsection{Degrees of belief}
\label{sec:org313e98e}
...
\label{sec:org88c28da}

\subsubsection{Degrees of preference}
\label{sec:org7dc5e3b}
...
\label{sec:org75be497}

\subsubsection{Objection 1}
\label{sec:org8257e8a}
...
\label{sec:org7cf16e6}

\subsubsection{Move 1}
\label{sec:orga8302b4}
...
As a \textbf{sophisticated consequentialist}, one can be \textbf{both a consequentialist and a feminist}. One can be responsive to both \textbf{feminist concerns about partiality} and the \textbf{demands of morality}.
 ...
 \newpage
\section{Deontology}
\label{sec:org91008b1}

\subsection{Hiroshima and Nagasaki}
\label{sec:org0a0144d}
\begin{itemize}
...
\subsection{Plato}
\label{sec:org84d9586}

\subsubsection{Context}
\label{sec:orga582f15}
\begin{itemize}
...
\label{sec:orgdd18276}

\subsubsection{Move 1}
\label{sec:org9127410}
\begin{itemize}
...
\label{sec:org79682f3}

\subsubsection{Greek philosophy}
\label{sec:org457d5b9}
\begin{itemize}
...
\label{sec:org1b4d5a9}

\subsubsection{Egoism problem}
\label{sec:orgaf46889}
\begin{itemize}
...
\label{sec:org8876baf}

\subsubsection{Egoism problem}
\label{sec:org5051430}
\begin{itemize}
...
\end{enumerate}
 ...
 \newpage
\subsection{Anscombe}
\label{sec:org1b6b690}

\subsubsection{Theses}
\label{sec:orgeadb590}
\begin{enumerate}
...
\end{center}
 ...
 \newpage
\section{How to research for the essay}
\label{sec:org75564cd}
\begin{itemize}
\item Use an LLM-based search engine to find philosopher essays.
\item Use Google Scholar, Semantic Scholar, and NTU OneSearch to find philosophy papers.
\item Use boolean operators like the * symbol to truncate your search term, like "consequential*". This search query will return results like "consequentialism" and "consequentialist".
\item The boolean search operators in NTU OneSearch are taken from \href{https://support.proquest.com/s/article/Search-Operators?language=en\_US}{ProQuest}, so you can look at the support article from \href{https://support.proquest.com/s/article/Search-Operators?language=en\_US}{ProQuest}.
\item Make use of the advanced search to get better filtering and to narrow down the search results.
\item Find literature reviews that summarise everything, ideally a review that is recent, like 2024 - 2025.
\item Use journal-specific filters, like \href{https://www.scimagojr.com/}{Scimago}, which ranks the scientific journals based on the number of citations.
\begin{itemize}
\item If every one of the cells in the journal ranking in \href{https://www.scimagojr.com/}{Scimago} is all green, that means it is one of the best journals.
\item Deprioritise articles from journals that don't have everything green in \href{https://www.scimagojr.com/}{Scimago}.
\item Look into the journal of philosophy, as it is a great journal for philosophy.
\end{itemize}
\item There should be roughly 100 citations for their most cited work.
\item Look at the year of the most cited article; it should be relatively recent, otherwise, the author isn't really relevant in the current year.
\item Use \href{https://philpapers.org/}{PhilPapers}, which is the philosophy equivalent of Google Scholar.
\item Use \href{https://philpapers.org/surveys/}{PhilPapers survey} to get metrics for the population's intuition.
\item Use the philosophy encyclopedias below, in order of quality and usefulness:
\begin{enumerate}
\item \href{https://plato.stanford.edu/}{Stanford Encyclopedia of Philosophy}
\item \href{https://www.rep.routledge.com/}{Routledge Encyclopedia of Philosophy}
\item \href{https://iep.utm.edu/}{Internet Encyclopedia of Philosophy}
\end{enumerate}
\end{itemize}
\end{document}
