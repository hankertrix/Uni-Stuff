...
in the \hyperref[orgd12c8af]{appendix}, and it is distributed under an open-source licence.
...
\label{sec:org1e08fb6}
\setcounter{tocdepth}{2}
\tableofcontents
\chapter{List of figures}
\label{sec:org60b0c15}
\listoffigures
\clearpage
...
\label{sec:org81ccbae}
The report is organised as follows:
\begin{itemize}
\item \hyperref[orgf8fe5d3]{Chapter 1}, which is this chapter, presents an introduction to step
counting. It includes the research motivation, objectives and scope,
as well as the organisation of the report.
\item \hyperref[orgbfe9aea]{Chapter 2} describes the literature review methodology,
summarises findings from the literature review and discusses
the gaps and possible improvements that can be made.
\item \hyperref[org80a8a25]{Chapter 3} explains the research methodology used,
...
\item \hyperref[orga2a01c9]{Chapter 4} presents the results of the research,
evaluating the accuracy and performance of the proposed algorithm.
\item \hyperref[org9ca0695]{Chapter 5} summarises the conclusions of the research and discusses
...
\item \hyperref[orgd12c8af]{The appendix} contains the full implementation of the algorithm.
\end{itemize}
\chapter{Literature review}
\label{sec:org6b7cb8e}
\label{orgbfe9aea}
...
This algorithm is illustrated in Figure \ref{fig:orgadafa68}.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./images/straczkiewicz-wavelet-transform.png}
\caption{\label{fig:orgadafa68}(A) shows the accelerometer magnitude. (B) shows the accelerometer magnitude projected onto the time-frequency domain using wavelet transformation. Brighter colours represent frequencies that have higher weights or are more prominent in the signal. (C) is (B) split up into 1-second windows. (D) The step frequency is estimated to be the frequency with the highest average wavelet coefficient in each 1-second window. (E) The total number of steps is the sum of the steps in each 1-second window, rounded to the nearest integer. \cslcitation{18}{[18]}}
\end{figure}
...
translated and scaled, and the original signal (Figure \ref{fig:org287ddf4}).
...
\caption{\label{fig:org287ddf4}The first row shows the acceleration magnitude. The second to fourth rows show the covariance (muted grey lines in the background), and the wavelet pattern (red and green lines). \cslcitation{13}{[13]}}
\end{figure}
...
please refer to the \hyperref[orgd12c8af]{appendix}.
...
\label{sec:org65d31d4}
\label{orga2a01c9}
\section{Walking}
\label{sec:org8cafead}

\subsection{50 steps data set}
\label{sec:orgfa110f3}
The details of how the data for the 50 steps data set is
collected is detailed in the \hyperref[org8247a6d]{data collection} section.
\phantomsection
\label{orgf56af18}
\begin{verbatim}
...
\begin{center}
\includegraphics[width=.9\linewidth]{./.ob-jupyter/d1337eafb0301b06a98b61d6c8b5d76d21cf2a2a.png}
\end{center}
...
Maximum error: 201.0
Mean absolute percentage error: 0.29880000000000007
Mean squared error: 23379.0
Root mean squared error: 152.90192935342574
\end{verbatim}

\begin{center}
\includegraphics[width=.9\linewidth]{./.ob-jupyter/dcfab35a11fc4cf1b65ce00545cd674c99089034.png}
\end{center}
...
\section{Running}
\label{sec:org86be92f}
The running data set is collected as detailed in the
\hyperref[org8247a6d]{data collection section}.
\phantomsection
\label{org3c27e2d}
\begin{verbatim}
Below are the accuracy metrics:
...
\begin{center}
\includegraphics[width=.9\linewidth]{./.ob-jupyter/ab0dd17180e27a023cbb6fc4fe8a827f74e1b854.png}
\end{center}

As seen from the box plots and accuracy metrics above,
the algorithm is quite accurate for running.
\section{Limping}
\label{sec:org731a3eb}
...
\begin{center}
\includegraphics[width=.9\linewidth]{./.ob-jupyter/594169e0a1c383bbf4fd56c83a4eb11d185d5e3f.png}
\end{center}
...
Maximum error: 18.0
Mean absolute percentage error: 0.15400000000000003
Mean squared error: 91.3
Root mean squared error: 9.555103348473002
\end{verbatim}

\begin{center}
\includegraphics[width=.9\linewidth]{./.ob-jupyter/d08c5dfc1c6c359018cf00632704aec7d28430ba.png}
\end{center}
...
\label{sec:org8bf4516}

\subsection{Climbing up stairs}
\label{sec:orgbd40633}
...
\begin{center}
\includegraphics[width=.9\linewidth]{./.ob-jupyter/b08177a9d1efa22707d54a37d9db31dfa7042b6c.png}
\end{center}
...
\begin{center}
\includegraphics[width=.9\linewidth]{./.ob-jupyter/05c8877ca92d666a6381ba84e9a22aea5aa5ded9.png}
\end{center}
...
\label{sec:org7dbbfef}

\subsection{Manual shaking}
\label{sec:org69338e2}
...
\begin{center}
\includegraphics[width=.9\linewidth]{./.ob-jupyter/a1a677e1b992395f965c1039291d3cfcbc211003.png}
\end{center}
...
\begin{center}
\includegraphics[width=.9\linewidth]{./.ob-jupyter/1da3f052ce5ea65c9da879bb574558a4de141283.png}
\end{center}
...
\label{sec:orga5fc3f3}
\label{org9ca0695}
\section{Conclusions}
\label{sec:org6db57a9}
This paper presents an open-source step-counting algorithm that aims
...
various aspects of detailed in the \hyperref[orgd12c8af]{appendix},
so anyone can make modifications to the algorithm to improve it.
\section{Recommendations for future work}
\label{sec:org8e40352}
...
\label{sec:org51a3b2e}
\label{orgd12c8af}
\section{Installation}
\label{sec:orgcb3e649}
...
\label{sec:org3390680}

\subsection{Loading the sensor data}
\label{sec:org8c64386}
\begin{minted}[]{python}
...
\label{sec:orgc472843}

\subsection{Obtaining the step count}
\label{sec:org5f5f928}
\begin{minted}[]{python}
...
\begin{center}
\includegraphics[width=.9\linewidth]{./.ob-jupyter/39d07de686d93e4bca945d088ec0827687a925f6.png}
\label{orgcd20fc7}
\end{center}
\end{document}
