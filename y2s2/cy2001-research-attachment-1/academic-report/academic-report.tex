...
in the \hyperref[orgbc9f4fa]{appendix}, and it is distributed under an open-source licence.
...
\label{sec:org024350d}
\setcounter{tocdepth}{2}
\tableofcontents
\chapter{List of figures}
\label{sec:orgf65cfbc}
\listoffigures
\clearpage
...
\label{sec:org18e58b7}
The report is organised as follows:
\begin{itemize}
\item \hyperref[org1d243e6]{Chapter 1}, which is this chapter, presents an introduction to step
counting. It includes the research motivation, objectives and scope,
as well as the organisation of the report.
\item \hyperref[org354d85a]{Chapter 2} describes the literature review methodology,
summarises findings from the literature review and discusses
the gaps and possible improvements that can be made.
\item \hyperref[org948f204]{Chapter 3} explains the research methodology used,
...
\item \hyperref[org2fafd27]{Chapter 4} presents the results of the research,
evaluating the accuracy and performance of the proposed algorithm.
\item \hyperref[orge5153a9]{Chapter 5} summarises the conclusions of the research and discusses
...
\item \hyperref[orgbc9f4fa]{The appendix} contains the full implementation of the algorithm.
\end{itemize}
\chapter{Literature review}
\label{sec:org797521c}
\label{org354d85a}
...
This algorithm is illustrated in Figure \ref{fig:orgfa5eeb2}.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./images/straczkiewicz-wavelet-transform.png}
\caption{\label{fig:orgfa5eeb2}(A) shows the accelerometer magnitude. (B) shows the accelerometer magnitude projected onto the time-frequency domain using wavelet transformation. Brighter colours represent frequencies that have higher weights or are more prominent in the signal. (C) is (B) split up into 1-second windows. (D) The step frequency is estimated to be the frequency with the highest average wavelet coefficient in each 1-second window. (E) The total number of steps is the sum of the steps in each 1-second window, rounded to the nearest integer. \cslcitation{18}{[18]}}
\end{figure}
...
translated and scaled, and the original signal (Figure \ref{fig:org4496067}).
...
\caption{\label{fig:org4496067}The first row shows the acceleration magnitude. The second to fourth rows show the covariance (muted grey lines in the background), and the wavelet pattern (red and green lines). \cslcitation{13}{[13]}}
\end{figure}
...
please refer to the \hyperref[orgbc9f4fa]{appendix}.
...
\label{sec:orgb1e66db}
\label{org2fafd27}
\section{Walking}
\label{sec:org2812c13}

\subsection{50 steps data set}
\label{sec:orga7c9808}
The details of how the data for the 50 steps data set is
collected is detailed in the \hyperref[org2b972e1]{data collection} section.
\phantomsection
\label{org6c703ee}
\begin{verbatim}
[31m---------------------------------------------------------------------------[39m
...
[32m----> [39m[32m1[39m walking_50_steps_results = [43mvalidate_algorithm_on_dataset[49m([33m"[39m[33m./data/walking/50-steps/[39m[33m"[39m)
[32m      3[39m [38;5;66;03m# Plot the box plot[39;00m
[32m      4[39m seaborn.boxplot(data={
[32m      5[39m     [33m"[39m[33mGround Truth[39m[33m"[39m: walking_50_steps_results.actual_step_count,
[32m      6[39m     [33m"[39m[33mAlgorithm Step Count[39m[33m"[39m: walking_50_steps_results.algorithm_step_count,
[32m      7[39m }).set(title=[33m"[39m[33mWalking for 50 steps[39m[33m"[39m)

[31mNameError[39m: name 'validate_algorithm_on_dataset' is not defined
\end{verbatim}
...
[32m----> [39m[32m1[39m walking_500_steps_results = [43mvalidate_algorithm_on_dataset[49m([33m"[39m[33m./data/walking/500-steps/[39m[33m"[39m)
[32m      3[39m [38;5;66;03m# Plot the box plot[39;00m
[32m      4[39m seaborn.boxplot(data={
[32m      5[39m     [33m"[39m[33mGround Truth[39m[33m"[39m: walking_500_steps_results.actual_step_count,
[32m      6[39m     [33m"[39m[33mAlgorithm Step Count[39m[33m"[39m: walking_500_steps_results.algorithm_step_count,
[32m      7[39m }).set(title=[33m"[39m[33mWalking for roughly 500 steps[39m[33m"[39m)
...
\section{Running}
\label{sec:org5a911fd}
The running data set is collected as detailed in the
\hyperref[org2b972e1]{data collection section}.
\phantomsection
\label{org79971d5}
\begin{verbatim}
[31m---------------------------------------------------------------------------[39m
...
[32m----> [39m[32m1[39m running_results = [43mvalidate_algorithm_on_dataset[49m([33m"[39m[33m./data/running/[39m[33m"[39m)
[32m      3[39m [38;5;66;03m# Plot the box plot[39;00m
[32m      4[39m seaborn.boxplot(data={
[32m      5[39m     [33m"[39m[33mGround Truth[39m[33m"[39m: running_results.actual_step_count,
[32m      6[39m     [33m"[39m[33mAlgorithm Step Count[39m[33m"[39m: running_results.algorithm_step_count,
[32m      7[39m }).set(title=[33m"[39m[33mRunning[39m[33m"[39m)
...
[32m----> [39m[32m1[39m limping_100_steps_results = [43mvalidate_algorithm_on_dataset[49m([33m"[39m[33m./data/limping/[39m[33m"[39m)
[32m      3[39m [38;5;66;03m# Plot the box plot[39;00m
[32m      4[39m seaborn.boxplot(data={
[32m      5[39m     [33m"[39m[33mGround Truth[39m[33m"[39m: limping_100_steps_results.actual_step_count,
[32m      6[39m     [33m"[39m[33mAlgorithm Step Count[39m[33m"[39m: limping_100_steps_results.algorithm_step_count,
[32m      7[39m }).set(title=[33m"[39m[33mLimping[39m[33m"[39m)
...
[32m----> [39m[32m1[39m shuffling_50_steps_results = [43mvalidate_algorithm_on_dataset[49m([33m"[39m[33m./data/shuffling/[39m[33m"[39m)
[32m      3[39m [38;5;66;03m# Plot the box plot[39;00m
[32m      4[39m seaborn.boxplot(data={
[32m      5[39m     [33m"[39m[33mGround Truth[39m[33m"[39m: shuffling_50_steps_results.actual_step_count,
[32m      6[39m     [33m"[39m[33mAlgorithm Step Count[39m[33m"[39m: shuffling_50_steps_results.algorithm_step_count,
[32m      7[39m }).set(title=[33m"[39m[33mShuffling[39m[33m"[39m)
...
\label{sec:org70ca103}

\subsection{Climbing up stairs}
\label{sec:org01cff0f}
...
[32m----> [39m[32m1[39m climbing_up_12_steps_results = [43mvalidate_algorithm_on_dataset[49m([33m"[39m[33m./data/climbing-up-stairs/[39m[33m"[39m)
[32m      3[39m [38;5;66;03m# Plot the box plot[39;00m
[32m      4[39m seaborn.boxplot(data={
[32m      5[39m     [33m"[39m[33mGround Truth[39m[33m"[39m: climbing_up_12_steps_results.actual_step_count,
[32m      6[39m     [33m"[39m[33mAlgorithm Step Count[39m[33m"[39m: climbing_up_12_steps_results.algorithm_step_count,
[32m      7[39m }).set(title=[33m"[39m[33mClimbing up stairs[39m[33m"[39m)
...
[32m----> [39m[32m1[39m climbing_down_12_steps_results = [43mvalidate_algorithm_on_dataset[49m([33m"[39m[33m./data/climbing-down-stairs/[39m[33m"[39m)
[32m      3[39m [38;5;66;03m# Plot the box plot[39;00m
[32m      4[39m seaborn.boxplot(data={
[32m      5[39m     [33m"[39m[33mGround Truth[39m[33m"[39m: climbing_up_12_steps_results.actual_step_count,
[32m      6[39m     [33m"[39m[33mAlgorithm Step Count[39m[33m"[39m: climbing_up_12_steps_results.algorithm_step_count,
[32m      7[39m }).set(title=[33m"[39m[33mClimbing down stairs[39m[33m"[39m)
...
\label{sec:org4721af0}

\subsection{Manual shaking}
\label{sec:org43f3401}
...
[32m----> [39m[32m1[39m manual_shaking_results = [43mvalidate_algorithm_on_dataset[49m([33m"[39m[33m./data/miscellaneous/manual-shaking/[39m[33m"[39m)
[32m      3[39m [38;5;66;03m# Plot the box plot[39;00m
[32m      4[39m seaborn.boxplot(data={
[32m      5[39m     [33m"[39m[33mGround Truth[39m[33m"[39m: manual_shaking_results.actual_step_count,
[32m      6[39m     [33m"[39m[33mAlgorithm Step Count[39m[33m"[39m: manual_shaking_results.algorithm_step_count,
[32m      7[39m }).set(title=[33m"[39m[33mManually shaking the accelerometer[39m[33m"[39m)
...
[32m----> [39m[32m1[39m eating_pasta_results = [43mvalidate_algorithm_on_dataset[49m([33m"[39m[33m./data/miscellaneous/eating-pasta/[39m[33m"[39m)
[32m      3[39m [38;5;66;03m# Plot the box plot[39;00m
[32m      4[39m seaborn.boxplot(data={
[32m      5[39m     [33m"[39m[33mGround Truth[39m[33m"[39m: eating_pasta_results.actual_step_count,
[32m      6[39m     [33m"[39m[33mAlgorithm Step Count[39m[33m"[39m: eating_pasta_results.algorithm_step_count,
[32m      7[39m }).set(title=[33m"[39m[33mEating pasta[39m[33m"[39m)
...
\label{sec:org63cd6c1}
\label{orge5153a9}
\section{Conclusions}
\label{sec:org056a494}
This paper presents an open-source step-counting algorithm that aims
...
various aspects of detailed in the \hyperref[orgbc9f4fa]{appendix},
so anyone can make modifications to the algorithm to improve it.
\section{Recommendations for future work}
\label{sec:org5e394ef}
...
\label{sec:orgba01af0}
\label{orgbc9f4fa}
\section{Installation}
\label{sec:org9286604}
...
\label{sec:orgb87e721}

\subsection{Loading the sensor data}
\label{sec:org814c074}
\begin{minted}[]{python}
...
\label{sec:org161c3f6}

\subsection{Obtaining the step count}
\label{sec:org352a7fe}
\begin{minted}[]{python}
...
\begin{center}
\includegraphics[width=.9\linewidth]{./.ob-jupyter/73edb000e9537e8455d3a50f19718d79e6742c05.png}
\label{org378d81e}
\end{center}
\end{document}
