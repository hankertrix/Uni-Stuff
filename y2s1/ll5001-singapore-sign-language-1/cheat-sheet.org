...
** And
Form the "C" hand sign but turn it such that the "C" shape is facing upwards, i.e. the open palm is facing inwards. Then bring your hand to the side while closing the "C" hand sign such that your fingers and thumb are touching each other.
