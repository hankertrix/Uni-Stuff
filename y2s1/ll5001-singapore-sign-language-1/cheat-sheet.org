...
** Translate
Make the "love" hand gesture, but instead of a closed fist use the "T" hand sign. Then rotate your wrists around each other and then expand the "T" hand sign into an index finger pointing to the left and right of you.
