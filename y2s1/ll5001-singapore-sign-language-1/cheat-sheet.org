...
** Our
Form a cup with one hand and touch the back of the thumb on the shoulder on the near side. Then, trace a semicircle before touching the side of the pinky on the other shoulder.
...
** Brunei
Have two open palms facing outwards, and make sure the thumb is outstretched from the rest of the fingers. Tilt both palms 45 degrees to the side and move them together such that both thumbs and the flesh below the thumbs are touching each other.
